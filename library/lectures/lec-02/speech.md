...
status: reviewed
version: v1.1
derives_from: [chapter.md v1.2, deck.yaml v1.7 (36 slides), plan-v2-final.md v2.1]
...
# Речь лектора · Лекция 2 v1.1

**Длительность:** 75 минут (62 мин активной речи по 36 слайдам + 6 мин retrieval-моментов + 2 мин на переходы + 5 мин Q&A-буфер).
**Версия:** v1.1 — Phase 11 batched revision на основе Phase 10 critic synthesis (`qa-reports/2026-05-14-phase10-speech-v1/SYNTHESIS.md`, APPROVE-WITH-POLISH).
...
«Первый из трёх кросс-сюжетных фреймов финала. Когда LLM — не правильный инструмент. Мы с вами теперь умеем это обосновать через механику.
