...
- **[s11 freshness Tesla Optimus]** Tesla Investor Update: `https://ir.tesla.com/`. Проверить deployment status — на май 2026 пилоты на десятках единиц, промышленная эксплуатация не подтверждена. Если Маск анонсировал V3 — обновить.
- **[s12 freshness Foxconn Wisconsin / Fairwater]** Microsoft Fairwater: `https://news.microsoft.com/source/topics/ai/`. Подтвердить 3,3 миллиарда + декабрь 2025 ещё 569 миллионов. Сверить sequence 13 000 анонс / 10 000 контракт / 281 фактических (NPR 2020) / 1 454 после пересмотра.
- **[s18 freshness Hyundai Atlas]** Hyundai investor pages + пресс-релиз RMAC (Hyundai Robotics Metaplant Application Center): `https://www.hyundai.news/`. Проверить целевую мощность тридцать тысяч единиц Atlas в год к 2028 — статус «анонс» либо обновлённый темп производства.
- **[s18 freshness Toyota GAIA]** Toyota Global AI Accelerator: проверить число AI-моделей, созданных сотрудниками. На 2024 — десять тысяч; смотреть на вторичные отраслевые обзоры, не финансовую отчётность Toyota. Заявка «10 000 часов в год» — vendor-сторона.
...
- **[s24 freshness BASF Geismar]** Поиск по `https://www.basf.com/global/en/media.html` за «soft sensor» / «Geismar». Подтвердить: процент 20-30% — отраслевой обзор, BASF Geismar конкретную цифру **публично не подтверждает**. Если BASF опубликовал свежие данные — обновить caveat.
- **[s25 freshness FKDPP]** Yokogawa-JSR — `https://www.yokogawa.com/news/`. 35 дней автономного контроля 2022 — исторический факт.
- **[s27 freshness POSCO]** POSCO Newsroom: `https://newsroom.posco.com/`. Проверить число edge-узлов (на 2024 — 180); если новая редакция «N+ узлов на 2026» — обновить.
- **[s28 freshness FDA Part 11 / AI/ML SaMD guidance]** FDA guidance updates 2023-2024 на `https://www.fda.gov/regulatory-information/search-fda-guidance-documents`. Сверить — конкретные guidance documents по AI/ML в SaMD контексте (включая Discussion Paper 2023, Action Plan 2024).
- **[s29 freshness Russian context]** Проверить публичные обзоры внедрений ИИ в Норникеле, СИБУРе, ММК, НЛМК, Северстали, КАМАЗе. Источники: ТАСС, РБК, Коммерсантъ. На май 2026 — большинство деклараций без верифицируемых производственных метрик. Финансовый контекст: прибыль Северстали –55% в 2024 году — обновить, если есть свежая отчётность.
- **[s27 freshness F-35 ALIS]** GAO reports: `https://www.gao.gov/search/F-35`. Подтвердить базовую линию 44 тысячи долларов за лётный час 2018 FY, оценка 35 тысяч FY2024; статус транзита на ODIN 2025-2028.
