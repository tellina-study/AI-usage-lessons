...
OUT = Path("/home/harness/harness-projects/256/.worktrees/folder-288/publish-8a63bf98/library/lectures/lec-05/rendered/assets-en/charts")
...
def main():
    ...
    gen("c12-fraud-stats.png", {
        ...
        "data": {
            "labels": [
                "Stripe Radar — fraud reduction, %",
                "JPMorgan — fewer false positives, %",
                "Visa — prevented, $ bn FY2023"],
            "datasets": [{
                "data": [32, 30, 40],
