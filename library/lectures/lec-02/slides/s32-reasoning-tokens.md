...
visual_brief: "Верх — схема: тот же авторегрессионный цикл (мини-версия s31), но выход раздвоен: широкая серая полоса «черновик „для себя“ — в ответ не попадает, в счёт попадает» (×3–10) и узкая teal полоса «видимый ответ». Низ слева — ценовой экспонат: три бара o4-mini / o3 / o3-pro, подпись «o3-pro $280/мес = 3.6× o3 = 18× o4-mini — при сопоставимой длине видимых ответов» (gold на 18×). Низ справа — две плашки: «управление: адаптивное мышление / effort вместо ручных бюджетов» и «в интерфейсе — пересказ рассуждения (summarized), не сырые токены». Gold callout про бюджет."
---
...
**o3-pro: $280/мес** в агентной нагрузке = **3.6× o3 = 18× o4-mini** *(gold)* — при сопоставимой длине видимых ответов; разницу делает объём рассуждения.
