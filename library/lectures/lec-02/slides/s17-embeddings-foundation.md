...
**Перефразирования.** «Как настроить SSL» и «Установка HTTPS-сертификата» — близкие векторы → модель отвечает одинаково.

**Синонимы.** «авто» и «машина» — близкие векторы → одна реакция.
