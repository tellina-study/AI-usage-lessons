...
learning_goal: "Эволюция context window + квадратичная стоимость внимания"
learning_outcomes: [LO6]
chapter_ref: "§3.3 [for-slide-s16]"
visual_brief: "Bar chart 3 точки на временной оси: GPT-3.5 (2022) 4k, Claude 3.5 (2024) 200k, Claude 4.7 (2026) 1M. Логарифмическая шкала. Bar 1M подсвечен gold. Callout: «стоимость внимания растёт квадратично. 1M ≈ 16× дороже 100k»."
verify_day_of: true
---
...
*Цифры приведены на май 2026 года; темп роста контекстного окна — примерно ×10 каждые 1-2 года. Перед лекцией стоит проверить актуальные значения для GPT-5, Claude 4.7 и Gemini.*
...
Источники:
[1] Anthropic — контекстное окно моделей Claude — рост окна 4k→200k→1M; порядок важнее точной цифры. https://www.anthropic.com/news/model-context-protocol [VFY-day-of]
