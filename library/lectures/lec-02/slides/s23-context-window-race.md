...
duration_min: 2
assertion: "Рабочий стандарт 2026 — окно 1–2 миллиона токенов; но «заявленное окно» и «полезное окно» — разные величины"
learning_goal: "Состояние гонки контекстных окон 2026: стандарт, маркетинговый полюс, контраст снизу; почему окно конечно"
learning_outcomes: [LO6]
chapter_ref: "§3.5 (chapter-part2.md) [for-slide-s23]"
visual_brief: "Bar chart на логарифмической шкале, Ocean rounded box: GPT-3.5 (2022) 4K → Claude 3.5 (2024) 200K → Fable 5 (2026) 1M (gold) и Gemini 3.5 Pro 2M (gold). Отдельно справа два выделенных контрастных бара: Llama 4 Scout «10M — заявлено, без бенчмарков качества» (штриховка, приглушённый) и YandexGPT 5 Pro 32K (контраст снизу). Внизу строка про позиционное кодирование. Gold callout про «платите за то, что кладёте в окно»."
verify_day_of: true
---
...
| **Claude Fable 5 (2026)** | **1 млн — без наценки за длину** *(gold)* |
| **Gemini 3.5 Pro (2026)** | **2 млн — крупнейшее среди боевых флагманов** *(gold)* |

[Два контрастных полюса, отдельные плашки]
- **Llama 4 Scout: «10 млн»** — заявлено; ни один опубликованный бенчмарк не подтверждает качество вблизи предела
- **YandexGPT 5 Pro: 32 тыс.** — на полтора-два порядка меньше флагманов
