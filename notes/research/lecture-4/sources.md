...
**Confidence:** HIGH
**Note:** **Gold standard case** для bias раздела. Pre-2024 но фундаментальный пример = systemic bias через proxy variable.
