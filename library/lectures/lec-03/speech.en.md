...
## [s01 · 3 min] — Air Canada: the chatbot invented a policy
...
[Do not read the subtitle; move to the lecture map.]

---

## [s02a · 1 min] — Lecture map: six sections
...
[We move to the recap.]

---

## [s03 · 1.5 min] — Recap of Lecture 2 and the bridge
...
[We move to the central question.]

---

## [s04 · 3 min] — The central question and the ladder
...
## [s05 · 2 min] — The default: a single call
...
[We move to roles in the prompt.]

---

## [s05a · 2 min] — Roles in the prompt: the myth of accuracy
...
[We move to prompt structure.]

---

## [s05b · 1.5 min] — Prompt structure: delimiters
...
[We move to chain-of-thought.]

---

## [s06 · 2.5 min] — Chain-of-thought and the limit of faithfulness
...
[We move to context engineering.]

---

## [s08 · 2.5 min] — Context engineering and context rot
...
[We move to the checklist.]

---

## [s08a · 1.5 min] — Checklist: how to build a prompt
...
## [s09 · 1 min] — Divider: Section 2, RAG
...
[We move to when RAG is NOT needed.]

---

## [s12 · 2.5 min] — When RAG is NOT needed
...
[We move to the RAG failure.]

---

## [s13 · 3 min] — RAG failure at scale, and Air Canada
...
[We move to Section 3.]

---

## [s13a · 0.3 min] — Divider: Section 3
...
## [s13b · 1.5 min] — What fine-tuning is
...
## [s15 · 2 min] — PEFT instead of full fine-tuning
...
[We move to the area of application and the criteria.]

---

## [s14 · 2.5 min] — Fine-tuning has narrowed, and the choice criteria
...
[We move to catastrophic forgetting.]

---

## [s16 · 2.5 min] — Catastrophic forgetting
...
[We move to Section 4.]

---

## [s18 · 1 min] — Divider: Section 4
...
## [s19 · 3 min] — The API layer and MCP
...
[We move to the agent loop.]

---

## [s21 · 3 min] — The agent loop
...
[We move to workflow versus agent.]

---

## [s22 · 2.5 min] — Workflow versus Agent
...
[We move to what an assistant-agent is made of.]

---

## [s22b · 3 min] — What an assistant-agent is made of
...
[We move to the agent's memory.]

---

## [s22c · 2.5 min] — The agent's memory
...
[We move to the failure of memory.]

---

## [s22d · 3 min] — The failure of memory
...
[We move to the operational layer.]

---

## [s22e · 2.5 min] — The operational layer: the presence paradox
...
[We move to skills, subagents, and access.]

---

## [s25 · 3.5 min] — Skills, subagents, access, and security
...
[We move to a review of real coding agents.]

---

## [s25b · 2.5 min] — Real coding agents through the harness frame
...
[We move to the failures of agents.]

---

## [s23 · 3 min] — The failures of agents
...
## [s25a · 0.3 min] — Divider: Section 5
...
## [s26 · 2 min] — The ladder of complexity
...
[We move to the choice route.]

---

## [s27 · 3 min] — The choice route
...
[We move to the agent starter kit.]

---

## [s27b · 2 min] — The agent starter kit
...
[We move to the human validator.]

---

## [s29 · 1.5 min] — The human validator and MIT NANDA
...
[We move to the finale.]

---

## [s30 · 1.5 min] — The bridge to Lecture 4
...
## [s31 · ~5 min] — Questions (Q&A buffer)
...
- s06 (`think_pause`): after the worked example with apples, hold the pause before the transition to faithfulness — this is now a single continuous fragment, watch the pace, the slide is dense.
...
A full rebuild for the new structure of Lecture 3 (deck v4.0, 40 slides, 88 min, issue #157). The old speech (v1.1, 36 slides, 75 min) was used as a stylistic base (tone, rhetorical devices, addresses to the audience); the content and the fragment breakdown were fully rebuilt for the new deck.
...
- **Section 1** — added s05a (roles in the prompt, the "persona = accuracy" myth debunked via Zheng et al. 2024 + arXiv:2605.29420) and s05b (structure/delimiters, the parallel with structured output and prompt injection); s06 merged the old CoT worked-example and faithfulness-limit into a single fragment with one timing block (2.5 min); added s08a (checklist of 8 items).
