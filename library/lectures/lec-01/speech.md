...
- **** Добавлена секция **[s05c]**— новый section divider «Раздел 1— Что такое AI» перед началом первого содержательного раздела (0.5 мин). Раньше раздел 1 начинался без явного дивайдера сразу после визитки лектора.
- **** Добавлена секция **[s07a]**— новый section divider «Раздел 2— Где мы сейчас» перед разделом про масштаб AI и прорывы (0.5 мин). Теперь все 5 содержательных разделов лекции открываются явным дивайдером с bridge-фразой «Раздел N из пяти»— раньше дивайдеры были только перед разделами 3/4/5.
...
- **** Добавлена секция **[s00a]**— короткое приветствие (~0.5 мин) перед титулом: что за курс, про что, чем не является.
- **** Добавлена секция **[s00b]**— хук курса (~1 мин): воронка внедрения 100%→10% + главный вопрос курса «не можно ли, а нужно ли и где». Теперь это первое содержательное высказывание лекции, до титула.
...
- **** [s17]— добавлен production-disclaimer (~30 сек): «чистые чаты в production почти не используются— везде агенты с RAG для долговременной памяти и поиска по корпоративной базе; граница „чат vs агент" размыта на production стороне».
