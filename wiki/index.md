...
Lectures: 1, 2, 3, 4, 5, 6, 8 (via LO1)
...
Lectures: 1-8 (micro-exercises), Seminars: 7, 12, 13
-> [Topic index](topics/prompt-engineering/_index.md)

## Learning Outcomes

| Code | Description | Lectures | Assessment |
|------|-------------|----------|------------|
| LO1 | Classify AI solutions, match to industry tasks | 1-6, 8 | Sem 5, 10, 17 |
| LO2 | Evaluate AI applicability to business tasks | 3-6, 8 | Sem 5, 10, 17 |
| LO3 | Analyze ethical risks of AI | 3, 4, 6, 7, 8 | Sem 5, 10, 17 |
| LO4 | Apply AI tools to analytical tasks | 1, 2 | Sem 1, 17 |
| LO5 | Formulate AI industry prospects | 5 | Sem 10, 17 |
| LO6 | Identify AI errors and limitations | 1 | Sem 1, 17 |
| LO7 | Justify critical verification of AI | 2, 7 | Sem 17 |
| LO8 | Formulate responsible AI principles | 7 | Sem 17 |
