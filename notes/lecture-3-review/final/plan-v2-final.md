...
**Slide count: 36** = s01–s30 monotonic + **6 suffix/append: s04a, s13a, s13b, s23a, s25a, s31** (owner-структурная ревизия после GATE-A QA, 2026-05-16). Suffix-ID схема (как lec-04 s05b/s08a/s13a) — намеренно, чтобы НЕ перенумеровывать s01–s30 и НЕ ломать `[for-slide-sNN]` маркеры главы (cascade-safe: глава не правится, новые слайды мапятся на существующие §).
