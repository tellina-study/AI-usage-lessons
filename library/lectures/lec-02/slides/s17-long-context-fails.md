...
visual_brief: "U-shape кривая: accuracy (Y, 0-100%) vs позиция факта в 100k контексте (X, начало→середина→конец). 70-80% начало, провал до 30% середина, 70-80% конец. Liu et al. 2023."
---
...
- Кривая: ~75% в начале → провал до ~30% в середине → ~75% в конце
- Провал в середине выделен gold
