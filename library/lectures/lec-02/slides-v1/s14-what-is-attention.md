...
Источники:
[1] Vaswani et al. (2017) — Attention Is All You Need — attention выдаёт распределение весов на токены контекста (Σ=1); 32–128 голов на слой. https://arxiv.org/abs/1706.03762
