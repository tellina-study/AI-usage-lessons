...
note: "Conversational. Local-binding РАЗРЕШЁН (речь для зала ИУ6 МГТУ Баумана). Mars Climate Orbiter — сквозной мотив (крючок ~s11, кульминация s23, callback в синтезе s30/s31)."
---

# Речь лектора · Лекция 6. AI в инженерном проектировании и CAD/CAM

**Длительность:** 75 минут. **Версия:** v1 (draft).
...
6. Сверить произносимые числа с финальным deck (drift-контроль, должны совпадать буквально): GM −~40% масса / +~20% прочность / 150+ вариантов; Airbus −~45% (~35 vs ~65 кг); Су-57 ~¼ легче; Mars $327 млн / ×4,45 / 1999; ORCA ~45–63%; Michell 1904 / Bendsøe–Kikuchi 1988 / SIMP 1989 / Коши 1847 / KKT 1939–1951 / Альтшуллер 1946. APM FEM «~70% объёма» — НЕ произносить точным числом (vendor-claim), только «существенную долю объёма, по заявлению вендора».
