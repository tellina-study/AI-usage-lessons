...
- Глубже по теме, которая зацепила: если bias — то сквозная тема последующих отраслевых лекций с систематизацией на финальной Лекции 17; если drug discovery — Recursion/Exscientia merger и индустриальная экономика AI biotech; если регулирование — EU AI Act timeline в деталях.
...
**Цели лекции достигнуты в речи.** LO1 — классификация четырёх типов AI-применений (s06) с примерами. LO2 — оценка через клинические данные MASAI, Goh, Liu (s11) и операционные mosmed.ai (s12). LO3 — этическая дилемма ответственности через 4-actor framework (s24). LO8 — три принципа как input для финального чек-листа Лекции 17 (s26, s28), framed как сырьё для черновика, не финал.

**Cross-references из chapter (синхронизировано с каноном course-plan.md).** Lec 1 callback — YOLO в s01, фрейм «где AI работает» в s05/s27, Нобель 2024 в s16. Финальный синтез Лекции 17 — LO8 input в s19/s24/s26/s27/s28; вход в копилку персонального чек-листа в s28.
