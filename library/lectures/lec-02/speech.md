...
**Длительность:** 75 минут (60 мин активной речи по 35 слайдам + 6 мин retrieval-моментов + 4 мин на переходы + 5 мин Q&A-буфер).
...
- **Frontmatter** — `slides_covered` (36→35, s27 убран), `derives_from` deck.yaml v1.7→v1.8, `length_words` пересчитан, `duration_min` breakdown обновлён (2 мин s27 ушли частично в буфер/переходы: +1 мин переходы, остальное — общий запас).
...
## [s01 · 2 мин] — На что вы сейчас НЕ обращаете внимания
...
## [s14 · 3 мин] — Внимание — распределение весов
