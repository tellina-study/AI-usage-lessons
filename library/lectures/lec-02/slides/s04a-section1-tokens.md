...
Введение закончено: мы зафиксировали центральный вопрос — что внутри LLM меняет то, как вы её используете, — и три промиса-якоря, на которые получим ответы к финалу.
