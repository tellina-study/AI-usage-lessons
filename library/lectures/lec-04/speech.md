...
- **[s22 freshness]** Открыть `https://www.beckershospitalreview.com/` поисковым запросом «ChatGPT healthcare 40 million». На 13 мая 2026 цифра ожидается ≥ 40M; если выросла — заменить устно.
...
Три вещи в этой демонстрации задают тон всей сегодняшней лекции. Первое: модель работает локально, в браузере. Снимок не уходит на сервер. Это не случайность — это design choice. Медицинские данные — особая категория, и мы с вами вернёмся к этому в четвёртом разделе.
...
«Давайте посмотрим конкретные цифры роста. В 2015 году FDA одобряло примерно шесть AI/ML-устройств за год. Между 1995 и 2015 годами кумулятивно — около тридцати трёх устройств, это три процента от текущего объёма.

К 2020 году годовой приток вырос до шестидесяти четырёх. А перелом — это 2022-2024 годы. В 2023 одобрено двести двадцать одно новое устройство. В 2024 — двести пятьдесят восемь. В 2025 — двести девяносто пять. Кумулятивно к концу 2025 года в списке тысяча четыреста пятьдесят один.
...
Давайте посмотрим на цифрах CheXNet на pneumonia detection: чувствительность около девяноста четырёх процентов, специфичность около восьмидесяти девяти. Звучит отлично. В больничной выборке, где prevalence пневмонии тридцать-пятьдесят процентов, PPV получается порядка восьмидесяти процентов. Хорошая клиническая метрика.
...
Это парадокс совместной работы. Обратите внимание: пользователи не дозагружают AI: не доверяют, не умеют интегрировать, держат AI на роли «второго мнения», которое можно проигнорировать.
...
Российский контекст. Центр AIDD — альянс Сбер AI Lab и AIRI, декабрь 2024. Альянсы Сбер плюс AIRI плюс Р-Фарм по онкологии CD137 и по Альцгеймеру. Peer-reviewed работы — MADD на EMNLP 2025 и DiMA на ICML 2025. Но честная оговорка: **ни одного российского AI-designed препарата в Phase 1 и выше на май 2026 не зафиксировано**. Все RU-программы — preclinical.»
...
«Четвёртый раздел из пяти — этика и ответственность.»

[Переход на s19.]

---

## Раздел 4. Этика и ответственность (15 мин)
...
**В марте 2023 года vendor Cass самовольно сменил Tessa с rule-based на generative LLM** — без согласования с NEDA. Тридцатого мая 2023 активистка Sharon Maxwell опубликовала скриншоты: Tessa советовал терять один-два фунта в неделю, удерживать дефицит калорий пятьсот-тысячу в день. Классические eating disorder triggers. NEDA сняла Tessa за двадцать четыре часа.

Frame — vendor accountability, не chatbot history. Cass изменил природу системы без согласования с principal. **Generative AI не равно rule-based AI.** Любой переход с deterministic на generative требует новой клинической валидации.
...
**Случай третий. Patient self-diagnosis.** Параллельно идёт массовое явление. По Becker's Hospital Review, **около сорока миллионов американцев** используют ChatGPT для healthcare. По Gallup — трое из пяти взрослых.
...
Числа. **Сто девяносто миллионов американцев** — затронутый объём PHI. Примерно пятьдесят семь процентов населения США. **Шесть терабайт** эксфильтровано. **Двадцать два миллиона долларов выкупа** заплачены в Bitcoin. Total recovery cost — **два миллиарда четыреста пятьдесят семь миллионов долларов**. Multi-week disruption обработки claims.
...
4-actor framework. Price, 2019, Stanford. Gerke, 2020, Elsevier. Четыре актора с разной комбинацией technical control и legal liability.
...
**Healthcare operator — больница, клиника, ДЗМ — средний control, средняя liability.** Выбирает поставщика AI. Обеспечивает тренинг персонала. Мониторит production. Деплоит AI без adequate тренинга — несёт ответственность за foreseeable misuse.

**AI-vendor — высокий control, низкая-средняя liability.** Дизайнит модель. Делает safety claims при регистрации. Обеспечивает PCCP-updates. Defect в design — liability по product liability. При faithful disclosure и proper post-market surveillance liability ограничена.

**Regulator — FDA, EU Notified Bodies, Росздравнадзор — низкий control, высокий oversight.** Approves системы. Проводит post-market surveillance. Не несёт liability за individual cases, но несёт systemic responsibility за качество approval process.
...
**Вывод первый. AI-диагностика работает.** Это LO1 и LO2. mosmed.ai обработал более четырнадцати миллионов исследований за пять лет в семидесяти четырёх регионах России. FDA одобрил тысячу четыреста пятьдесят одно AI/ML-устройство кумулятивно к концу 2025 года; семьдесят шесть процентов — радиология. MASAI Sweden RCT подтвердил, что AI-supported маммография повышает чувствительность скрининга с семидесяти трёх с половиной до восьмидесяти с половиной процентов при снижении нагрузки радиолога на сорок четыре. Это не футурология. Это computer-vision-pipeline уровня 2017-2024 годов в production-форме.
