...
**Длительность:** 75 минут (61.5 мин активной речи + 13.5 мин буфера на Q&A и регулировку темпа).
...
- **[Структура]** Добавлена секция **[s05c]** — новый section divider «Раздел 1 — Что такое AI» перед началом первого содержательного раздела (0.5 мин). Раньше раздел 1 начинался без явного дивайдера сразу после визитки лектора.
- **[Структура]** Добавлена секция **[s07a]** — новый section divider «Раздел 2 — Где мы сейчас» перед разделом про масштаб AI и прорывы (0.5 мин). Теперь все 5 содержательных разделов лекции открываются явным дивайдером с bridge-фразой «Раздел N из пяти» — раньше дивайдеры были только перед разделами 3/4/5.
...
- **[WPM cleanup]** При пересчёте после правок обнаружены 5 фрагментов >95 WPM (s05a 194→80, s07a 126→88, s12 113→92, s19a 119→79, s22 129→83 слов/мин) — все ужаты без потери содержания, ни один фрагмент не превышает 95 WPM.
- **[Pacing]** Активная речь 60.5 → 61.5 мин (+1.0 от 2 новых 0.5-мин дивайдеров s05c/s07a). Буфер 14.5 → 13.5 мин. Сумма 75 мин сохранена. Секция 1 «Что такое AI» 6.5→7.0 мин, секция 2 «Где мы сейчас» 6→6.5 мин (sync с deck.yaml pacing).
