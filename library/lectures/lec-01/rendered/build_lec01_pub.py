...
OUT = ROOT / "rendered/lec-01-pub.pptx"
FONT_HEAD = "Arial"
FONT_BODY = "Arial"
...
def page_number(slide, n, total=None, *, color=SLATE):
    ...
    return None  # pub build: footer «N / TOTAL» disabled (footer-less)
...
BUILDERS = [
    ...
    build_s27, build_s28,
    # pub build: build_s29 (Карта семестра — Bauman) removed.
    # pub build: build_s29a (Оценка за семестр — Bauman) removed.
    build_s30, build_s31,
]
