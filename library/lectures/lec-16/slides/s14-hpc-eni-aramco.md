...
HPC (высокопроизводительные вычисления)-гонка Q3 — это разные стратегии у каждой крупной компании.
...
Два урока. Первое — один и восемь десятых миллиарда долларов — самоотчётный, не аудированное число. Второе — METABRAIN внутренний продукт, не продаётся наружу. Это competitive moat и одновременно структурное отличие от BP + Beyond Limits и IBM + Repsol, которые мы разберём через два слайда.
