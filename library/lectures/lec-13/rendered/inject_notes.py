#!/usr/bin/env python3
"""
inject_notes.py — Phase 8b P0 fix.
...
Запускать ПОСЛЕ build_lec13.py — каждый rebuild стирает notes
(build_lec13.py ставит file-references). Текущий контракт:
  python3 library/lectures/lec-13/rendered/build_lec13.py
  python3 library/lectures/lec-13/rendered/inject_notes.py

Issue #135 Phase 8b P0.
"""
import re
import sys
...
WT = Path('/tmp/lec-13-wt/library/lectures/lec-13')
PPTX = WT / 'rendered' / 'lec-13.pptx'
