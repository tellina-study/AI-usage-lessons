...
Каждая лекция: **≥30%** содержания — провалы ИИ + выученные уроки, фундаментальные ограничения/риски, явные критерии «здесь ИИ не нужен», или сравнение с более правильным альтернативным инструментом. Измерение **холистическое**: доля ≥30% видна **во всех 3 артефактах** (chapter / slides / speech), не сконцентрирована в одном.
