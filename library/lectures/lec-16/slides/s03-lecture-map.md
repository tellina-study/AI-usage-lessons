...
Sub: «Не по value chain, а по структуре AI-задачи: данные × процессы» (16pt italic).

Roadmap (7 горизонтальных rounded cards, каждая в Ocean motif):

1. **Keystone-матрица** — данные × процессы, 4 квадранта.
...
5. **Q4 Новые опоры** — CCS + EGS (2 pilots · 2 провала).
