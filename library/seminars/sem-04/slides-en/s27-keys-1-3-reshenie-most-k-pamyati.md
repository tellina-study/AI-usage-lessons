...
duration_min: 1.5
assertion: "The root file stayed the same, thirteen lines long: the detail went off into a comment on the function, the test convention already sits in the tests themselves, not a single nested instruction file got set up — and knowledge that appears in the course of the work has a different address, and that is section two"
...
visual:
  ...
  backup: "The product layer of the tree — assets/captures/21-tree-stage1.txt; spec.md, README.md and DECISIONS.md were set up on day 0 and did not make it into that git snapshot, and the grown tests/ matches the month-1 scenario. On the slide the state of the repository is shown in full."
---
...
The root file stayed the same, thirteen lines long: the detail went off into a comment on the function, the test convention already sits in the tests themselves, not a single nested instruction file got set up — and knowledge that appears in the course of the work has a different address, and that is section two.
...
spec.md
DECISIONS.md
CLAUDE.md              ← the same 13 lines, no growth
