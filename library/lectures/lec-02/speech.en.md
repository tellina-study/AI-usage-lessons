...
**Duration:** 75 minutes (60 min of active speech across 35 slides + 6 min of retrieval moments + 4 min for transitions + 5 min Q&A buffer).
...
- **Frontmatter** — `slides_covered` (36→35, s27 removed), `derives_from` deck.yaml v1.7→v1.8, `length_words` recomputed, `duration_min` breakdown updated (the 2 min of s27 went partly into the buffer/transitions: +1 min transitions, the rest — general slack).
...
## [s01 · 2 min] — What you are NOT paying attention to right now

[I bring up the first slide. On screen — a question in large type, below it a character being pulled in three directions at once.]
...
[pause, give the room a second to think]
...
[point at the character being pulled in three directions]
...
[pause, sub-line on the slide]

Your brain chooses every second what matters and what is background.

[point to the bridge line at the bottom of the slide]
...
[On the slide — a large "02", the title.]
...
## [s02a · 30 sec] — Lecture map

[On the slide — six numbered cards, a gold marker on "Section 0".]
...
## [s03 · 1.5 min] — Deepening the "model" layer from Lecture 1

[On the slide — on the left, the layered diagram from Lecture 1 with the bottom layer highlighted; on the right, a bullet bridge.]
...
## [s04 · 1 min] — The main question of the lecture

[On the slide — the central question in large type, below it three promise anchors.]
...
## [s04a · 30 sec] — Section 1: Tokenization

[On the slide — a large "Section 1", below it "Tokenization".]
...
## [s04b · 1 min] — Data flow in an LLM

[On the slide — a horizontal 7-stage pipeline.]
...
## [s05 · 2 min] — A token is an id from the model's vocabulary

[On the slide — three examples of token markup.]
...
## [s06 · 2 min] — BPE — a compromise

[On the slide — two columns Before / After.]
...
## [s07 · 3 min] — Why AI is bad at counting letters

[On the slide — on the left the breakdown of `strawberry`, on the right three consequences.]
...
[point at the three cards on the right]
...
## [s08 · 2 min] — The same text: more expensive in Russian

[On the slide — a bar chart of tokens/character for four languages.]
...
## [s08a · 30 sec] — Section 2: Embeddings

[On the slide — a large "Section 2", below it "Embeddings".]
...
## [s09 · 2 min] — What an embedding is

[On the slide — a diagram of a token-to-vector lookup.]
...
[point at the call-out on the right]
...
## [s09a · 1.5 min] — The embedding space

[On the slide — a 2D scatter with three clusters.]
...
[point at the three fact-cards on the right]
...
## [s10 · 3 min] — Semantic similarity on sentences

[On the slide — a 5×5 cosine similarity heatmap.]
...
## [s12 · 2 min] — Embeddings — the foundation of LLM understanding

[On the slide — on the left a vertical pipeline, on the right three cards.]
...
[point at the pipeline on the left]
...
## [s13 · 30 sec] — Section 3: The attention mechanism

[On the slide — a large "Section 3".]
...
## [s13a · 2 min] — Attention is a matrix

[On the slide — a 7×7 attention matrix.]
...
[point at the fact-cards on the right]
...
## [s14 · 3 min] — Attention — a distribution of weights

[On the slide — on the left a flashlight, on the right a bar chart of the distribution.]

"Now by meaning. What attention produces at its output. A convenient metaphor — a flashlight in a dark room.

[point at the flashlight on the left]
...
## [s15 · 5 min] — A working example and the role effect

[On the slide — Part A with three arrows; Part B — two prompts.]
...
[pause 30 seconds, give the audience time]
...
## [s16 · 2 min] — The context window

[On the slide — a bar chart with three points: GPT-3.5, Claude 3.5, Claude 4.7.]
...
## [s17 · 2 min] — Lost in the middle

[On the slide — a U-shape curve.]
...
## [s17a · 30 sec] — Section 4: Sampling

[On the slide — a large "Section 4".]
...
## [s18 · 2.5 min] — The probability distribution

[On the slide — a bar chart of the top-5 candidates.]
...
## [s19 · 3 min] — Temperature

[On the slide — three copies of the distribution with different T.]

"The main sampling parameter is temperature. A single API parameter. It controls how "sharp" the choice will be.

[point at the three graphs]
...
## [s20 · 2 min] — 4 API knobs per scenario

[On the slide — a 5×5 table.]
...
## [s21 · 2 min] — The autoregressive loop

[On the slide — a closed loop of five steps.]
...
## [s22 · 1 min] — Local vs cloud

[On the slide — two columns Local vs Cloud.]
...
## [s22a · 30 sec] — Section 5: Finale

[On the slide — a large "Section 5".]
...
## [s23 · 1 min] — The inference pipeline

[On the slide — a horizontal 4-stage pipeline.]

"Let's fold it all into one diagram. The LLM inference pipeline — four stages.

[point stage by stage]
...
## [s24 · 2 min] — The three "whys" closed

[On the slide — three cards with the answers.]
...
## [s25 · 1.5 min] — When not an LLM

[On the slide — a decision tree with three branches.]
...
## [s26 · 1 min] — Attention ≠ causality

[On the slide — Human vs AI side-by-side.]
...
## [s28 · 1.5 min] — Bridge to Lecture 3

[On the slide — the 4 concepts of Lecture 3.]
...
[On the slide — a large "Q&A", below it "Thank you for your attention".]
...
[Q&A up to 5 minutes, after that — the end of the lecture.]
