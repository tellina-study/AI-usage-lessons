...
visual_brief: "Большая «02» в outline gold, title 60pt, hero motif справа (4-стадийный pipeline иконка). Roadmap-bar внизу: 5 пронумерованных карточек (0 Открытие / 1 Токены / 2 Эмбеддинги / 3 Внимание / 4 Сэмплинг / 5 Финал), gold-маркер «Вы здесь — Раздел 0»."
---
...
- 0. Открытие  ← **Вы здесь** (gold-маркер)
- 1. Токенизация
- 2. Эмбеддинги
- 3. Механизм внимания
- 4. Сэмплинг
