...
strict_in_share: "~48% (failure-cases + criteria + alternatives distributed across §1–§4)"
...
Главная мысль — **лестница структурированности среды**, пять уровней от склада к чёрному лебедю. Если в конце у студентов останется лестница и пять критериев решения — лекция удалась.

Тон — «доверяй, но проверяй». Около половины контента — про провалы. AV — одна из самых дорогих историй сожжения венчурного капитала. Cruise (s29) — самый эмоциональный. Uber Tempe (s30) — самый тяжёлый, тихо. UPS ORION (s16) и решающая рамка (s38) — главные анти-хайп моменты.
...
Лекция тяжёлая. Около половины — про провалы. Это намеренно.
...
**Октябрь 2022 — Argo AI.** Самый крупный провал. **Семь миллиардов сожжено за пять лет.** Ford — более пяти миллиардов, VW — два и шесть десятых. 26 октября 2022 Ford объявил свертывание. Двадцать тысяч увольнений. Ford списал два миллиарда семьсот плюс восемьсот двадцать семь миллионов убытка.
...
**Центральная окупаемость лекции.** Пять критериев — AI или не AI.
...
Что **переносится** — пять вопросов критического суждения: где ML работает в-распределении, где слеп; где OR лучше; где человек в петле обязателен; как отличить демо от продакшена; когда AI — неправильный инструмент.
