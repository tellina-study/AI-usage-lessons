...
duration_min: 0.2
assertion: "Раздел 4-bis — Среда. Cross-cutting meta-уровень: связь / привязка к поставщику / регуляторика. Все три — failure-перспектива. Без них ни одна ступень лестницы не работает."
learning_goal: "Visual divider — переход в Р4-bis + 7-card progress bar с gold-подсветкой Р4-bis"
learning_outcomes: [LO5]
chapter_ref: "frontmatter"
references: []
visual:
  pattern: section_divider_with_progress
  primary: "Большое «4-bis» + title + 1-фраза-фрейм + 7-card progress bar с gold-подсветкой Р4-bis"
---

# Раздел 4-bis — Среда: связь, привязка, регуляторика

## Assertion

Раздел 4-bis — Среда. Cross-cutting meta-уровень: связь / привязка к поставщику / регуляторика. Все три — failure-перспектива. Без них ни одна ступень лестницы не работает.
...
Этот раздел — cross-cutting meta-уровень. Он не описывает ещё одну ступень лестницы; он описывает общие условия среды, без которых ни одна из ступеней не работает. Все три подраздела — связь, привязка к поставщику, регуляторика — строго failure-перспектива.
...
И это три анти-ИИ критерия, которые завершают пятёрку для consolidation: AP-пять про связь, AP-шесть про vendor lock-in, AP-семь про AI-MRV без direct measurement — последний уже введён в разделе про Verra.

## Источники

- Chapter v3.1 §5 Часть 3.
