...
### [s18 · 2 мин] Архитектура «инженер в петле»
...
## §8. Закрытие + мост к Лекции 13 (~5 мин)

### [s39 · 5 мин] Закрытие — Toyota Digit как первая ступень цепи поставок
...
2. **Toyota Digit deployment на s25 и s39.** Проверить https://www.agilityrobotics.com/news + Toyota Motor Corporation newsroom. На s25 и s39 указано «семь и более единиц». Если опубликовано обновление к дате лекции — заменить.
...
9. **Locked numbers reference card.** Распечатать страницу с ключевыми числами: 36→180 миллиардов / 155 миллиардов / 17,15 миллиарда / 75% twin fail / 11–14% energy expectation (EY 2025) / 40% agentic / 99% vision (vs ~50% legacy) / 100 годных / 10:1 PdM (vs календарное) / 57× cement / 35 days Yokogawa / 85% PLC Copilot / M65535 / 220+ Lighthouse / 94% multi-tech / 16% EBIT / Waymo 6+ городов ~3000 ед. / Cruise приостановлен 10.2023, GM закрыт 12.2024.
