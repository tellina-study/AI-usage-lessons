...
def build_s29(p):
    ...
    Module reshuffle:
    - Лекция 6 (Инж. проектирование) moved Модуль 1 → Модуль 2.
    - Лекция 8 (Креативные индустрии) moved Модуль 1 → Модуль 3.
    Modules now: M1 = lec 1-5, 7 (6 lectures); M2 = lec 6, 9-12 (5 lectures);
    M3 = lec 8, 13-17 (6 lectures).
    ...
    # Each module is now a list of (lecture_number, label) tuples — non-contiguous OK.
    modules = [
