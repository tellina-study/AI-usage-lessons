...
visual_brief: "Большая «02» в outline gold, title, subtitle «Конвейер инференса — и шесть границ, которые меняют инженерные решения» + hero motif (4-стадийная конвейер-иконка). Без roadmap-bar (карта — s02a)."
---
