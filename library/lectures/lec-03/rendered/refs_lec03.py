...
SLIDE_REFS = {
    ...
    "s-mcp-api": [
        ("1", "MCP-Universe (arXiv:2508.14704) — лучший результат 43,7%", "mcp_universe",
         "лучшая модель на реальных MCP-серверах даёт 43,7% задач; >56% реальных задач провалено", True),
...
ANCHORS = {
    ...
    "s-rag-chunk3": [("1", "Самый большой выигрыш дала не «умная» нарезка, а уважение структуры."),
    ...
    "s-agent-when": [("1", "GPT-4o 61% pass@1 → 25% pass@8"),
                     ("2", "17,2×")],
    "s19": [("1", "N+M")],
    "s-mcp-api": [("1", "лучший результат на MCP-Universe"),
