...
ANCHORS = {
    ...
    "s-rag-elastic": [("1", "на этом масштабе pgvector или гибрид Elastic/OpenSearch скучный правильный ответ"),
                      ("2", "ELSER без GPU-сервиса эмбеддингов")],
    ...
    "s-rag-design": [("1", "индекс отстал → тихая деградация"),
                     ("2", "recall@k ~0,8, nDCG")],
    ...
    "s-rag-cases": [("1", "Retrieval-дизайн выводится из природы данных."),
                    ("2", "17–33% галлюцинаций при «0%»"),
                    ("3", "Cody убрал эмбеддинги → лексика")],
