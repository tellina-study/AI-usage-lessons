...
visual_brief: "Bar chart токены/символ: EN ~0.25, RU ~0.5 (gold), ZH ~0.8, Python ~0.4. Строка динамики: o200k_base — примерно −35% нелатинским, разрыв сокращается, но не исчезает. Callout: любой лимит в токенах калибруйте на своём языке."
---
