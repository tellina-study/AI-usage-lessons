...
- **Моделирование CCS** — миграция облака CO₂ в подземных хранилищах на десятки и сотни лет (cross-link к Разделу 4 — Q4 новые опоры (CCS + EGS)).
...
**[→ Часть 3 (Раздел 3 — Q2 метановая MRV + Раздел 4 — Q4 новые опоры (CCS + EGS))](chapter-part3.md)**
