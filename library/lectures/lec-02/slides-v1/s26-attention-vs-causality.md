...
duration_min: 1
assertion: "Внимание статистически смотрит на токены — не понимает причинности"
...
Подзаголовок: «ИИ считает корреляции в данных, не строит каузальный граф»

## Body
[2 Ocean rounded boxes side-by-side, parallel structure]

**Человек**
- «X произошло, **потому что** Y» — **модель причинности — строит механизмы**
...
**ИИ (через внимание)**
- «X **следует за** Y в данных» — **статистическая корреляция, не причинность**
