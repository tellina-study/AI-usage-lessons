...
visual_brief: "3 Ocean rounded boxes с ответами на 3 «почему», визуально параллельные (одинаковый акцент): (1) role-токены во внимании (s15), (2) токенизатор объединяет буквы (s05-s07), (3) сэмплинг при T > 0 (s18-s19)."
---
...
→ На уровне внимания **role-токены получают высокий вес**, и модель опирается на них при выборе следующих токенов.
