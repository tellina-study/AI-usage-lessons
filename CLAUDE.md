...
**Измерение — холистическое.** Доля ≥30% должна быть видна **во всех трёх артефактах** (`chapter.md`, slides/deck, `speech.md`), а не сконцентрирована в одном. Базовая метрика — доля слов / слайдов / минут, посвящённых bucket'у выше.
